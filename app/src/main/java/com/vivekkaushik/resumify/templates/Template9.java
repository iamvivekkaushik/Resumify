...
public class Template9 implements Template {
    ...
    public Template9(Context context, Resume resume) {
        mContext = context;
        this.resume = resume;
    }
    ...
    public PdfDocument createPdf() {
        ...
        paint.setColor(Color.parseColor("#1BFFE0"));
        ...
        paint.setColor(Color.parseColor("#0C1213"));
    ...
    private void drawContactSection() {
        ...
        if (!resume.getAddress().isEmpty()) drawDetails(1623 + MARGIN, currentRightY + 12,
                1648 + MARGIN, currentRightY + 45, R.drawable.black_location, resume.getAddress());

        if (!resume.getMobile().isEmpty()) drawDetails(1616 + MARGIN, currentRightY + 15,
                1656 + MARGIN, currentRightY + 40, R.drawable.black_phone, resume.getMobile());

        if (!resume.getEmail().isEmpty()) drawDetails(1620 + MARGIN, currentRightY + 18,
                1650 + MARGIN, currentRightY + 40, R.drawable.black_mail, resume.getEmail());

        if (!resume.getWebsite().isEmpty()) drawDetails(1620 + MARGIN, currentRightY + 20,
                1650 + MARGIN, currentRightY + 45, R.drawable.black_web, resume.getWebsite());
    ...
    private void drawExperienceSection() {
        ...
        drawHeading(MARGIN + 20, currentLeftY + 8, MARGIN + MARGIN - 10,
                currentLeftY + MARGIN - 19, R.drawable.black_person, "EXPERIENCE");
    ...
    private void drawEducationSection() {
        ...
        drawHeading(MARGIN + 25, currentLeftY + 2, MARGIN + MARGIN - 15,
                currentLeftY + MARGIN - 13, R.drawable.black_bulb, "EDUCATION");
        currentLeftY += MARGIN + MEDIUM_GAP + 10;
    ...
    private void drawProjects() {
        ...
        drawHeading(MARGIN + 20, currentLeftY + 8, MARGIN + MARGIN - 10,
                currentLeftY + MARGIN - 19, R.drawable.startup, "PROJECTS");
        currentLeftY += MARGIN + MEDIUM_GAP + 10;
    ...
    private void drawReference() {
        ...
        drawHeading(MARGIN + 20, currentLeftY + 8, MARGIN + MARGIN - 10,
                currentLeftY + MARGIN - 19, R.drawable.manager, "REFERENCE");
        currentLeftY += MARGIN + MEDIUM_GAP + 10;
