...
public class Template7 implements Template {
    private static final String TAG = "Template7";
    ...
    public Template7(Context context, Resume resume) {
        mContext = context;
        this.resume = resume;
    }
    ...
    public PdfDocument createPdf() {
        ...
        paint.setColor(Color.parseColor("#F8FAB7"));
    ...
    private void drawContactSection() {
        ...
        if (!resume.getAddress().isEmpty()) drawDetails(1623 + MARGIN, currentRightY + 12,
                1648 + MARGIN, currentRightY + 45, R.drawable.yellow_location, resume.getAddress());

        if (!resume.getMobile().isEmpty()) drawDetails(1616 + MARGIN, currentRightY + 15,
                1656 + MARGIN, currentRightY + 40, R.drawable.yellow_phone, resume.getMobile());

        if (!resume.getEmail().isEmpty()) drawDetails(1620 + MARGIN, currentRightY + 18,
                1650 + MARGIN, currentRightY + 40, R.drawable.yellow_mail, resume.getEmail());

        if (!resume.getWebsite().isEmpty()) drawDetails(1620 + MARGIN, currentRightY + 20,
                1650 + MARGIN, currentRightY + 45, R.drawable.yellow_web, resume.getWebsite());
    ...
    private void drawExperience() {
        ...
        drawHeading(MARGIN + 20, currentLeftY + 8, MARGIN + MARGIN - 10,
                currentLeftY + MARGIN - 19, R.drawable.yellow_person, "EXPERIENCE");
    ...
    private void drawEducationSection() {
        ...
        drawHeading(MARGIN + 25, currentLeftY + 2, MARGIN + MARGIN - 15,
                currentLeftY + MARGIN - 13, R.drawable.yellow_bulb, "EDUCATION");
        currentLeftY += MARGIN + MEDIUM_GAP + 10;
    ...
    private void drawProjects() {
        ...
        drawHeading(MARGIN + 20, currentLeftY + 8, MARGIN + MARGIN - 10,
                currentLeftY + MARGIN - 19, R.drawable.project_gold, "PROJECTS");
        currentLeftY += MARGIN + MEDIUM_GAP + 10;
    ...
    private void drawReference() {
        ...
        drawHeading(MARGIN + 20, currentLeftY + 8, MARGIN + MARGIN - 10,
                currentLeftY + MARGIN - 19, R.drawable.reference_gold, "REFERENCE");
        currentLeftY += MARGIN + MEDIUM_GAP + 10;
